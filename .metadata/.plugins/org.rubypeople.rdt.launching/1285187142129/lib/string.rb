...
---------
     ...
     sort_by, sum, take, take_while, to_a, to_set, zip),
     Mocha::StringMethods(mocha_inspect)
...
-----------------
     ...
     end_with?, ends_with?, eql?, expand_ch_hash, ext, gsub, gsub!,
     hash, hex, include?, indent, index, initialize_copy, insert,
     ...
     original_succ, original_succ!, partition, pathmap, pathmap_explode,
     pathmap_partial, pathmap_replace, replace, reverse, reverse!,
     rindex, rjust, rpartition, rstrip, rstrip!, scan, scanf,
     shellescape, shellsplit, size, slice, slice!, split, squeeze,
     squeeze!, start_with?, starts_with?, strip, strip!, sub, sub!,
     succ, succ!, sum, swapcase, swapcase!, tabto, to_blob, to_date_lex,
     to_date_time_lex, to_f, to_i, to_i_lex, to_s, to_str, to_sym,
     to_time_lex, to_yaml, toeuc, tojis, tosjis, toutf16, toutf8, tr,
     tr!, tr_s, tr_s!, treetop_camelize, unpack, upcase, upcase!, upto
