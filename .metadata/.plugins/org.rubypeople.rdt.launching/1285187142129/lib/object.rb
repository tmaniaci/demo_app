...
---------
     ...
     chop, chop!, class_eval, debugger, enable_warnings, eval, exec,
     exit, exit!, fail, fork, format, gem, getc, gets, global_variables,
     gsub, gsub!, iterator?, lambda, load, local_variables,
     log_open_files, loop, method_missing, open, open_uri_original_open,
     orig_open, p, pp, pretty_inspect, print, printf, proc, putc, puts,
     raise, rand, readline, readlines, require, require_library_or_gem,
     ...
     trace_var, trap, untrace_var, warn, with_warnings, y),
...
-----------------
     ...
     freeze, frozen?, hash, html_safe?, id, inspect, instance_eval,
     instance_exec, instance_of?, instance_variable_defined?,
     instance_variable_get, instance_variable_names,
     instance_variable_set, instance_variables, is_a?, is_haml?,
     kind_of?, method, methods, nil?, object_id, or_ask, presence,
     present?, private_methods, protected_methods, public_methods,
