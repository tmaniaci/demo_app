...
-----------------
     ...
     eof, eof, eof?, eof?, fcntl, fileno, flush, fsync, getbyte, getc,
     gets, isatty, length, lineno, lineno=, lines, path, pid, pos, pos,
     pos=, print, printf, putc, puts, read, readbyte, readchar,
     readline, readline, readlines, reopen, rewind, rewind, seek, seek,
     size, string, string=, sync, sync=, sysread, syswrite, tell,
