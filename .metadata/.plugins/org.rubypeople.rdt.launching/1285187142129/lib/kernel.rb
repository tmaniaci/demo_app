...
-----------------
     ...
     fail, fork, format, gem, getc, gets, global_variables, gsub, gsub!,
     ...
     select, set_trace_func, silence_stream, silence_warnings,
     singleton_class, sleep, split, sprintf, srand, sub, sub!, suppress,
     syscall, system, test, throw, to_ptr, trace_var, trap, untrace_var,
     warn, with_warnings, y
